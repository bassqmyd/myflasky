...
def extract_path_info(environ_or_baseurl, path_or_url, charset='utf-8',
    ...
    >>> extract_path_info(myappp'myappllo')
    u'/hello'
    >>> extract_path_info('http://example.com/myapp',
    ...                   'https://example.com/myapp/hello')
    u'/hello'
    >>> extract_path_info('http://example.com/myapp',
    ...                   'https://example.com/myapp/hello',
...
class DispatcherMiddleware(object):
    ...
    This is useful if you want to combine multiple WSGI applications::
        ...
        myapp = DispatcherMiddleware(myapp, {
            '/app2':        app2,
            '/app3':        app3
        })
    """
...
class ClosingIterator(object):
    ...
    is a boring task this class can be used for that::
        ...
        return ClosingIterator(myapp(environ, start_response), [cleanup_session,
                                                              cleanup_locals])
