...
class Manager(object):
    ...
    def __call__(self, app=None, **kwargs):
        ...
        if app is None:
            app = self.app
            if app is None:
                raise Exception("There is no myapp here. This is unlikely to work.")
    ...
    # def foo(self, myapp, *args, **kwargs):
    #     print(args)
    ...
    def shell(self, func):
        ...
        Decorator that wraps function in shell command. This is equivalent to::
            ...
            def _make_context(myapp):
                return dict(myapp=myapp)

            manager.add_command("shell", Shell(make_context=_make_context))

        The decorated function should take a single "myapp" argument, and return
        a dict.
    ...
    def handle(self, prog, args=None):
        ...
        for handle in func_stack:
            ...
            # pass only safe myapp config keys
